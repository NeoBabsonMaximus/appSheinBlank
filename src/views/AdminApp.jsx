// Admin App Component and Router (View Layer)
...
const AdminApp = () => {
  ...
  // Función para navegación con datos entre páginas
  const navigateToPageWithData = (page, data = null) => {
    if (page === 'pedidos' && data) {
    ...
    switch (currentPage) {
      ...
      case 'pedidos':
        return <PedidosPage 
          ...
          shouldOpenModal={!!pendingOrderData}
          onDataConsumed={() => setPendingOrderData(null)}
        />;
      case 'pedidos-archivados':
        return <PedidosArchivadosPage />;
      case 'catalogo':
        return <CatalogoPage onCreateOrder={navigateToPageWithData} />;
      case 'clientes':
        return <ClientesPage />;
      case 'finanzas':
        return <FinanzasPage />;
